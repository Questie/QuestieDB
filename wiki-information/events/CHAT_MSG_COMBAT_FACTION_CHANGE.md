...
**Title:** CHAT MSG COMBAT FACTION CHANGE

**Content:**
Fires when you gain reputation with a faction. 
...
**Payload:**
- `text`
  - *string* - e.g. "Your reputation with Timbermaw Hold has very slightly increased."
- `playerName`
