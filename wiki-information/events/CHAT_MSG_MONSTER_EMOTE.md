...
**Payload:**
1. `text`
   - *string* - The chat message body, such as "%s attempts to run away in fear!"
2. `playerName`
...
5. `playerName2`
   - *string* - If applicable, the player triggering the NPC emote.
6. `specialFlags`
