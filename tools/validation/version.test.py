...
class VersionTest(LuaFixture):
    ...
    def test_generation_preserves_versions_and_rejects_invalid_inputs_before_writes(self):
        ...
        self.assertTrue(source_bytes.startswith(b"## Interface: "))
        self.assertEqual(b"# GENERATED by `lua generate.lua toc`, and COMMITTED.", source_bytes.splitlines()[1])
        ...
        self.assertTrue(baked_bytes.startswith(
            b"## Interface: 11508, 11509\n"
            b"# GENERATED by `lua generate.lua Vanilla`. Do not edit, do not commit.\n"
        ))
