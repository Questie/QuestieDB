...
local function writeHeader(out, flavor, fileList)
  -- Keep Interface first: leading comments were reported to break metadata reads on Mists.
...
function generate.baseToc()
  ...
  -- Match the Baked header's Interface-first ordering for Mists compatibility.
