...
function generate.baseToc()
  ...
  out:write("## Notes-deDE: |cFFFFD100(source mode)|r Die Questie-Datenbank\n")
  out:write("## Notes-esES: |cFFFFD100(source mode)|r La base de datos de Questie\n")
  out:write("## Notes-esMX: |cFFFFD100(source mode)|r La base de datos de Questie\n"
  out:write("## Notes-frFR: |cFFFFD100(source mode)|r La base de données de Questie\n")
  out:write("## Notes-ptBR: |cFFFFD100(source mode)|r O banco de dados do Questie\n")
  out:write("## Notes-ruRU: |cFFFFD100(source mode)|r База данных Questie\n")
  out:write("## Notes-koKR: |cFFFFD100(source mode)|r Questie 데이터베이스\n")
  out:write("## Notes-zhCN: |cFFFFD100(source mode)|r Questie 数据库\n")
  out:write("## Notes-zhTW: |cFFFFD100(source mode)|r Questie 資料庫\n")
  -- Rolling previews keep a commit in their visible version even though the release tag moves.
