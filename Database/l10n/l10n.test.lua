...
l10n.RunGetTest = function(fast)
  do
    local success, error = pcall(l10n.testItemGetFunctions, fast)
    if not success then
      print("l10n Item test failed: " .. error)
  ...
  do
    local success, error = pcall(l10n.testNpcGetFunctions, fast)
    if not success then
      print("l10n Npc test failed: " .. error)
  ...
  do
    local success, error = pcall(l10n.testObjectGetFunctions, fast)
    if not success then
      print("l10n Object test failed: " .. error)
  ...
  do
    local success, error = pcall(l10n.testQuestGetFunctions, fast)
    if not success then
      print("l10n Quest test failed: " .. error)
