...
function QuestieWotlkItemFixes:Load()
    ...
    return {
        ...
        [20874] = { -- Idol of the Sun
            [itemKeys.npcDrops] = {15229,15230,15233,15235,15236,15240,15246,15247,15249,15250,15252,15262,15264,15277,15311,15312},
        },
        [20875] = { -- Idol of Night
            [itemKeys.npcDrops] = {15229,15230,15233,15235,15236,15240,15246,15247,15249,15250,15252,15262,15264,15277,15311,15312},
        },
        ...
        [34786] = { -- Super Strong Metal Plate (#4681)
            [itemKeys.npcDrops] = {},
        },
        ...
        [43288] = { -- Smelted Metal Bar
            [itemKeys.objectDrops] = {193004},
        },
        [43323] = { -- Quiver of Dragonbone Arrows
            [itemKeys.npcDrops] = {30842,30872},
        },
