...
# This regex matches the "---@class Factions:OverrideFactions" comment, any characters in between (non-greedy),
# and "QuestCorrection.sortKeys = {"
sort_keys_block_start_regex = r"---@class Factions:OverrideFactions.*?Faction\.factions\s*=\s*\{"
