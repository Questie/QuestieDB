...
quest_sortkey_file_path = os.path.join(current_dir(), "..", "QuestSort.lua")

# This regex matches the "---@class QuestSortKeys:OverrideQuestSortKeys" comment, any characters in between (non-greedy),
# and "QuestCorrection.sortKeys = {"
sort_keys_block_start_regex = r"---@class QuestSortKeys:OverrideQuestSortKeys.*?QuestCorrection\.sortKeys\s*=\s*\{"
