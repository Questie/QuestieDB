...
function QuestFixes:Load()
  ...
  local ICON_TYPE_TALK = Questie and Questie.ICON_TYPE_TALK or "ICON_TYPE_TALK"
     ...
     local retData = {
        ...
        [1141] = {
            [questKeys.extraObjectives] = {{{[zoneIDs.DARKSHORE]={{35.71,44.68}}}, ICON_TYPE_EVENT, l10n("Fish for Darkshore Groupers"),}},
        },
        [1144] = {
        ...
        [1380] = {
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, l10n("Use the War Horn Mouthpiece to summon Khan Hratha"), 0, {{"object", 138497}}}},
        },
        [1381] = {
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, l10n("Use the War Horn Mouthpiece to summon Khan Hratha"), 0, {{"object", 138497}}}},
        },
        ...
        [1579] = {
            [questKeys.extraObjectives] = {{{[zoneIDs.DARKSHORE]={{35.71,44.68}}}, ICON_TYPE_EVENT, l10n("Fish for Gaffer Jacks"),}},
        },
        [1580] = {
            [questKeys.requiredSkill] = {356,30},
            [questKeys.extraObjectives] = {{{[zoneIDs.DARKSHORE]={{50.7,23.8},{40,73.6},{44.3,74.4},{53.3,32.4},{43.3,80.6}}}, ICON_TYPE_EVENT, l10n("Fish for Electropellers"),}},
        },
        [1581] = { -- bad race data
            [questKeys.requiredRaces] = raceIDs.ALL_ALLIANCE,
        },
        ...
        [2930] = {
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_OBJECT, l10n("Step 1: obtain the Yellow Punch Card. You need the White Punch Card."), 0, {{"object", 142345}}},
                                           {nil, ICON_TYPE_OBJECT, l10n("Step 2: obtain the Blue Punch Card. You need the Yellow Punch Card."), 0, {{"object", 142475}}},
                                           {nil, ICON_TYPE_OBJECT, l10n("Step 3: obtain the Red Punch Card. You need the Blue Punch Card."), 0, {{"object", 142476}}},
                                           {nil, ICON_TYPE_OBJECT, l10n("Step 4: obtain the Prismatic Punch Card. You need the Red Punch Card."), 0, {{"object", 142696}}},
            },
        ...
        [3520] = {
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_SLAY, l10n("Slay Vale Screechers and use Yeh'kinya's Bramble on their corpse."), 0, {{"monster", 5307},{"monster", 5308}}}},
        },
        [3525] = {
        ...
        [3628] = {
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_TALK, l10n("Teleport to the top of the mountain."), 0, {{"object", 153203},{"monster", 8816}}},
                                          {nil, ICON_TYPE_EVENT, l10n("Use the Ward of the Defiler to summon Razelikh."), 0, {{"object", 153205}}},
			},
        },
        [3629] = {
            [questKeys.requiredSpecialization] = specKeys.ENGINEERING,
        ...
        [3909] = {
            ...
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, l10n("Place the Bait in front of Miblon Snarltooth."), 0, {{"monster", 9467}}}},
        },
        [3982] = {
        ...
        [4024] = {
            ...
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, l10n("Use the Altered Black Dragonflight Molt on Bael'gar's corpse."), 0, {{"monster", 9016}}}},
        },
        [4083] = {
        ...
        [4507] = {
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_OBJECT, l10n("Use the Gorishi Queen Lure."), 0, {{"object", 174792}}}},
        },
        [4542] = {
        ...
        [4729] = {
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, l10n("Use the Empty Worg Pup Cage to capture it."), 0, {{"monster", 10221}}}},
        },
        [4734] = {
            [questKeys.objectives] = {nil,{{400062,"Test the Eggscilliscope Prototype"}}},
        },
        [4735] = {
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_OBJECT, l10n("Collect eggs using the Collectronic Module."), 0, {{"object", 400062}}}},
        },
        [4736] = {
            [questKeys.requiredRaces] = raceIDs.ALL_ALLIANCE,
        },
        ...
        [4743] = {
            ...
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_OBJECT, l10n("Beat Emberstrife till his will is broken, then place the Unforged Seal of Ascension before him and use the Orb of Draconic Energy."), 0, {{"monster", 10321}}},
			                               {nil, ICON_TYPE_OBJECT, l10n("Use the Flames of the Black Flight over it to create the Seal."), 0, {{"object", 175321}}},
			},
        },
        [4763] = {
            [questKeys.requiredSourceItems] = {12341,12342,12343,12347}, -- #798
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, l10n("Summon Xabraxxis once you have the required items from the Blackwood Stores."), 0, {{"object", 175338}}}},
        },
        [4764] = {
        ...
        [4867] = {
            ...
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_OBJECT, l10n("Combine Omokk's Head with the Roughshod Pike."),0,{{"object", 175621}}},
			                               {nil, ICON_TYPE_OBJECT, l10n("Use it to instantly kill one nearby ogre."),0,{{"object", 400063}}},
			},
        },
        [4881] = {
        ...
        [5088] = {
            ...
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_OBJECT, l10n("Light the Sacred Fire of Life"),0,{{"object", 175944}}}},
        },
        [5089] = {
        ...
        [5561] = {
            ...
            [questKeys.extraObjectives] = {{{[zoneIDs.DESOLACE]={{60.58,62}}}, ICON_TYPE_EVENT, l10n("Lure the Kodos to Smeed Scrabblescrew."),}},
        },
        [5582] = {
        ...
        [5721] = {
            ...
            [questKeys.extraObjectives] = {{{[zoneIDs.EASTERN_PLAGUELANDS]={{38.8,91.2}}}, ICON_TYPE_EVENT, l10n("Place the Relic Bundle in the Town Square."),}},
        },
        ...
        [5781] = {
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_OBJECT, l10n("Search the false grave for the Taelan's Hammer."), 0, {{"object", 177240}}}},
        },
        [8519] = {
        ...
        [6027] = {
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_OBJECT, l10n("Summon Lord Kragaru"), 0, {{"object", 400060}}}},
        },
        [6041] = {
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_OBJECT, l10n("Plant the bomb!"), 0, {{"object", 177668}}}},
        },
        [6061] = {
        ...
        [6134] = {
            [questKeys.extraObjectives] = {{{[zoneIDs.DESOLACE]={{63.71,91.9}}}, ICON_TYPE_EVENT, l10n("Place the Crate of Ghost Magnets"),}},
        },
        [6136] = {
        ...
        [7640] = {
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_OBJECT, l10n("Exorcise the spirits"), 0, {{"object", 179747}}}},
        },
        [7668] = { -- #1344
        ...
        [8149] = {
            [questKeys.requiredRaces] = raceIDs.ALL_ALLIANCE,
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, l10n("Place a tribute at Uther's Tomb"),0,{{"object", 180204},}}},
        },
        [8150] = {
            [questKeys.requiredRaces] = raceIDs.ALL_HORDE,
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, l10n("Place a tribute at Grom's Monument"),0,{{"object", 180205},}}},
        },
        [8166] = {
            [questKeys.specialFlags] = 0,
        },
        ...
        [8315] = {
            [questKeys.extraObjectives] = {{{[zoneIDs.SILITHUS]={{47.50,54.50}}}, ICON_TYPE_EVENT, l10n("Draw the glyphs into the sand to summon the Qiraji Emissary."),}},
        },
        [8317] = {
        ...
        [8332] = {
            [questKeys.preQuestSingle] = {},
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, l10n("Summon a Templar using a full Twilight set."),2,{{"object", 180456},{"object", 180518},{"object", 180529},{"object", 180544},{"object", 180549},{"object", 180564},}}},
        },
        [8341] = {
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, l10n("Summon a Duke using a full Twilight set and neck."),2,{{"object", 180461},{"object", 180534},{"object", 180554},}}},
        },
        [8348] = {
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, l10n("Summon a Duke using a full Twilight set and neck."),0,{{"object", 180461},{"object", 180534},{"object", 180554},}}},
        },
        [8352] = {
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, l10n("Summon a Lord using a full Twilight set, neck and ring."),0,{{"object", 180466},{"object", 180539},{"object", 180559},}}},
        },
        [8353] = {
        ...
        [8361] = {
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, l10n("Summon a Templar using a full Twilight set."),0,{{"object", 180456},{"object", 180518},{"object", 180529},{"object", 180544},{"object", 180549},{"object", 180564},}}},
        },
        [8368] = {
        ...
        [8481] = {
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, l10n("Plant the Demon Summoning Torch"),0,{{"object", 180673}}}},
        },
        [8484] = {
        ...
        [8507] = {
            [questKeys.extraObjectives] = {{nil, ICON_TYPE_TALK, l10n("Ask to see the Captain."),0,{{"monster", 15443}}}},
        },
        [8509] = {
            [questKeys.requiredLevel] = 1,
            [questKeys.requiredRaces] = raceIDs.ALL_ALLIANCE,
        ...
        [65602] = {
            ...
            [questKeys.zoneOrSort] = sortKeys.WARLOCK,
            [questKeys.extraObjectives] = {{{[zoneIDs.ASHENVALE]={{26.7,22.5}}}, ICON_TYPE_EVENT, l10n("Light the Unlit Torch near a fire and use the Burning Torch to set the Archaeologist's Cart on fire."),}},
        },
        [65603] = {
            [questKeys.name] = "The Binding",
